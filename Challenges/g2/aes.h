...
#ifndef CHALLENGES_AES_H
#define CHALLENGES_AES_H
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
#include<string>
...
static const uint8_t inv_SBox[256] = {0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e, 0x81, 0xf3, 0xd7, 0xfb,
...
void AddRoundKey(uint8_t data[16], uint8_t *RoundKey);
...
//void Encrypt(uint8_t plaintext[16], uint8_t Key[16], uint8_t *encrypted_message);
/*=================================================Decryption=======================================================*/
...
//void Decrypt(uint8_t ciphertext[16],uint8_t Key[16], uint8_t *decrypted_message);

/*=================================================I/O=======================================================*/
vector<uint8_t> word_to_byte(string word);

//string generate(bool use_default=false);
//string AES_encrypt(const string& message, const string& Key);
void print_message(uint8_t message[16], int length);

#endif //CHALLENGES_AES_H